...
var locations = {};
var statesMap = {
    'AL': {locations: [], displayName: 'Alabama'},
    'AK': {locations: [], displayName: 'Alaska'},
    'AZ': {locations: [], displayName: 'Arizona'},
    'AR': {locations: [], displayName: 'Arkansas'},
    'CA': {locations: [], displayName: 'California'},
    'CO': {locations: [], displayName: 'Colorado'},
    'CT': {locations: [], displayName: 'Connecticut'},
    'DE': {locations: [], displayName: 'Delaware'},
    'DC': {locations: [], displayName: 'District of Columbia'},
    'FL': {locations: [], displayName: 'Florida'},
    'GA': {locations: [], displayName: 'Georgia'},
    'HI': {locations: [], displayName: 'Hawaii'},
    'ID': {locations: [], displayName: 'Idaho'},
    'IL': {locations: [], displayName: 'Illinois'},
    'IN': {locations: [], displayName: 'Indiana'},
    'IA': {locations: [], displayName: 'Iowa'},
    'KS': {locations: [], displayName: 'Kansas'},
    'KY': {locations: [], displayName: 'Kentucky'},
    'LA': {locations: [], displayName: 'Louisiana'},
    'ME': {locations: [], displayName: 'Maine'},
    'MD': {locations: [], displayName: 'Maryland'},
    'MA': {locations: [], displayName: 'Massachusetts'},
    'MI': {locations: [], displayName: 'Michigan'},
    'MN': {locations: [], displayName: 'Minnesota'},
    'MS': {locations: [], displayName: 'Mississippi'},
    'MO': {locations: [], displayName: 'Missouri'},
    'MT': {locations: [], displayName: 'Montana'},
    'NE': {locations: [], displayName: 'Nebraska'},
    'NV': {locations: [], displayName: 'Nevada'},
    'NH': {locations: [], displayName: 'New Hampshire'},
    'NJ': {locations: [], displayName: 'New Jersey'},
    'NM': {locations: [], displayName: 'New Mexico'},
    'NY': {locations: [], displayName: 'New York'},
    'NC': {locations: [], displayName: 'North Carolina'},
    'ND': {locations: [], displayName: 'North Dakota'},
    'OH': {locations: [], displayName: 'Ohio'},
    'OK': {locations: [], displayName: 'Oklahoma'},
    'OR': {locations: [], displayName: 'Oregon'},
    'PA': {locations: [], displayName: 'Pennsylvania'},
    'RI': {locations: [], displayName: 'Rhode Island'},
    'SC': {locations: [], displayName: 'South Carolina'},
    'SD': {locations: [], displayName: 'South Dakota'},
    'TN': {locations: [], displayName: 'Tennessee'},
    'TX': {locations: [], displayName: 'Texas'},
    'UT': {locations: [], displayName: 'Utah'},
    'VT': {locations: [], displayName: 'Vermont'},
    'VA': {locations: [], displayName: 'Virginia'},
    'WA': {locations: [], displayName: 'Washington'},
    'WV': {locations: [], displayName: 'West Virginia'},
    'WI': {locations: [], displayName: 'Wisconsin'},
    'WY': {locations: [], displayName: 'Wyoming'}
};
var map;
